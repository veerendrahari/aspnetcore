        ...
        if (context.AllowCacheStorage && context.OutputCacheStream.BufferingEnabled)
        {
                    ...
                    && HttpMethods.IsHead(context.HttpContext.Request.Method)))
            {
                ...
                else
                {
                    ...
                    await OutputCacheEntryFormatter.StoreAsync(context.CacheKey, context.CachedResponse, context.Tags, context.CachedResponseValidFor, _store, context.HttpContext.RequestAborted);
                }
            }
            else
            {
